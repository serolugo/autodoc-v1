...
Format: <id_prefix>-<YYMMDD><tile_number:04X><id_version><id_revision>
...
def generate_tile_id(
    ...
    - tile_number   : 4-digit global consecutive number, hexadecimal format
    ...
    tile_num_str = f"{tile_number:04X}"
